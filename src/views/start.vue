...
<template>
  <div class="start-container overflow-hidden flex w-screen h-screen relative">
    ...
    <div
      class="start-content-container bg-gradient-to-b from-white to-slate-100 relative"
    >
